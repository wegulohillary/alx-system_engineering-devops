...
File 100-change_owner_and_group creates a script that changes the owner to vinent and the group owner to staff for all the files and directories in the working directory.
